...
export namespace Prisma {
  ...
  */
  ...
  type GetIssueGroupByPayload<T extends IssueGroupByArgs> =
  ...
  type IssueGetPayload<
    S extends boolean | null | undefined | IssueDefaultArgs,
  ...
  > {
    ...
    findUnique<T extends IssueFindUniqueArgs>(
      ...
      $Result.GetResult<Prisma.$IssuePayload<ExtArgs>, T, "findUnique"> | null,
      null,
      ExtArgs
    >;
    ...
    findUniqueOrThrow<T extends IssueFindUniqueOrThrowArgs>(
      ...
      $Result.GetResult<Prisma.$IssuePayload<ExtArgs>, T, "findUniqueOrThrow">,
      never,
      ExtArgs
    >;
    ...
    findFirst<T extends IssueFindFirstArgs>(
      ...
      $Result.GetResult<Prisma.$IssuePayload<ExtArgs>, T, "findFirst"> | null,
      null,
      ExtArgs
    >;
    ...
    findFirstOrThrow<T extends IssueFindFirstOrThrowArgs>(
      ...
      $Result.GetResult<Prisma.$IssuePayload<ExtArgs>, T, "findFirstOrThrow">,
      never,
      ExtArgs
    >;
    ...
    findMany<T extends IssueFindManyArgs>(
      ...
      $Result.GetResult<Prisma.$IssuePayload<ExtArgs>, T, "findMany">
    >;
    ...
    create<T extends IssueCreateArgs>(
      ...
      $Result.GetResult<Prisma.$IssuePayload<ExtArgs>, T, "create">,
      never,
      ExtArgs
    >;
    ...
    delete<T extends IssueDeleteArgs>(
      ...
      $Result.GetResult<Prisma.$IssuePayload<ExtArgs>, T, "delete">,
      never,
      ExtArgs
    >;
    ...
    update<T extends IssueUpdateArgs>(
      ...
      $Result.GetResult<Prisma.$IssuePayload<ExtArgs>, T, "update">,
      never,
      ExtArgs
    >;
    ...
    upsert<T extends IssueUpsertArgs>(
      ...
      $Result.GetResult<Prisma.$IssuePayload<ExtArgs>, T, "upsert">,
      never,
      ExtArgs
    >;
  ...
  export type IssueScalarWhereWithAggregatesInput = {
    AND?:
      | IssueScalarWhereWithAggregatesInput
      | IssueScalarWhereWithAggregatesInput[];
